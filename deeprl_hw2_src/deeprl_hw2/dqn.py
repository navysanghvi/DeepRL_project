...
class DQNAgent(object):
    ...
    ######################################## UPDATE NETWORK ########################################
    def update_policy(self, reward, terminal):
    ...
    ######################################## TRAINING ########################################
    def fit(self, epochs=10, max_episode_length=200, callbacks=None, interval=10000):
        ...
        for epoch in epochs:
            ...
            for image_name, sentence, bbox_gt in image_data.list_data:
                episode += 1; logging.on_episode_begin(episode)
                ...
                while 1:
                    ...
                    # Update policy
                    metrics = self.update_policy(reward,terminal=done)
